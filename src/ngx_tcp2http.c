...
static char *ngx_tcp2http_block(ngx_conf_t *cf, ngx_command_t *cmd, void *conf);
...
ngx_str_t  ngx_tcp2http_html_default_types[] = {
    ngx_string("text/html"),
    ngx_null_string
};


static ngx_command_t  ngx_tcp2http_commands[] = {
...
static ngx_core_module_t  ngx_tcp2http_module_ctx = {
    ngx_string("tcp2http"),
    NULL,
    NULL
};
...
ngx_module_t  ngx_tcp2http_module = {
    NGX_MODULE_V1,
    &ngx_tcp2http_module_ctx,                  /* module context */
    ngx_tcp2http_commands,                     /* module directives */
...
static char *
ngx_tcp2http_block(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    char                        *rv;
    ngx_uint_t                   mi, m, s;
    ngx_conf_t                   pcf;
...
ngx_http_add_listening(ngx_conf_t *cf, ngx_http_conf_addr_t *addr)
{
    ...
    ls->handler = ngx_tcp2http_init_connection;
